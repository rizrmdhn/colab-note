...
const InsideToolbarButton = React.forwardRef<
...
InsideToolbarButton.displayName = "InsideToolbarButton";

const ToolbarButton = withTooltip(InsideToolbarButton);
ToolbarButton.displayName = "ToolbarButton";

export { ToolbarButton };

export const ToolbarSplitButton = React.forwardRef<
  React.ComponentRef<typeof ToolbarButton>,
...
ToolbarSplitButtonPrimary.displayName = "ToolbarButton";
...
ToolbarSplitButtonSecondary.displayName = "ToolbarButton";
